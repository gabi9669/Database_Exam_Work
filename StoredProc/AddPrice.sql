...
--						'PLAT[1];PLAT[2]',
--						'TYPE[1];TYPE[2]',
--						'(PLAT[1]TYPE[1]PRICE;PLAT[2]TYPE[1])'s PRICE;(PLAT1TYPE[2]PRICE,PLAT[2]TYPE[2])'s PRICE',
--						'(PLAT[1]TYPE[1]MODIF;PLAT[2]TYPE[1])'s MODIF;(PLAT1TYPE[2]MODIF,PLAT[2]TYPE[2])'s MODIF'
--						
--EXAMPLE:						
